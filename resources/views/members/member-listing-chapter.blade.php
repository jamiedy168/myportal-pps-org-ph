    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid px-2 px-md-4">
        ...
        <div class="card card-body mx-3 mx-md-4 mt-n6">
            ...
            <hr>
            <div class="row mt-4">
                <div class="col-lg-3 col-md-6 col-6 mt-2 mb-4">
                    <div class="card">
                        <div class="card-body p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                ...
                                <h4 class="mb-0">{{ $diplomate_count }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-6 mt-2 mb-4">
                    <div class="card">
                        <div class="card-body p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <p class="text-sm mb-0 text-capitalize">Emeritus Fellow</p>
                                <h4 class="mb-0">{{ $emeritus_fellow }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-6 mt-2 mb-4">
                    <div class="card">
                        <div class="card-body p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <p class="text-sm mb-0 text-capitalize">VIP's</p>
            ...
            <form class="form-horizontal" action="{{ route('member-search-listing-chapter') }}" method="GET" autocomplete="off">
                @csrf
                <div class="row mt-2">
                                    ...
                                    <tr class="bg-gray-10">
                                        ...
                                        <td>
                                            <div class="d-flex flex-column">
                                                ...
                                                <a class="mb-2 text-sm text-danger" href="/member-info/{{ Crypt::encrypt( $member2->pps_no )}}" style="font-weight: bold">{{ $member2->first_name }} {{ $member2->middle_name }} {{ $member2->last_name }} {{ $member2->suffix }}</a>
