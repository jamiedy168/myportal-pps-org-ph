              ...
              <div class="col-12">
                  <div class="card mb-4">
                      ...
                      <div class="card-body pb-2">
                          <form class="form-horizontal" action="{{ route('icd-admin-neonatal-view-search') }}" method="GET" autocomplete="off">
                              <div class="row mb-2">
                                  <div class="col-12">
                                      <div class="row justify-content-md-center">
                                          <div class="col-lg-6 col-12">
                                              ...
                                              <div class="input-group input-group-outline" id="titleRow" style="margin-top: -5px !important">
                                                  <select name="hospital_id" class="form-control hospital">
                                                      <option value="">Choose Hospital</option>
                                                      @foreach ($hospital_list as $hospital_list2)
                                                          <option value="{{ $hospital_list2->id }}" {{ ($hospital_list2->id == $hospital_id) ? 'selected' : '' }}>{{ $hospital_list2->hosp_name }}</option>
                                                      @endforeach
                              ...
                              <div class="row mt-3 justify-content-md-center">
                                  <div class="col-12 col-md-12" >
                                      ...
                                      <a class="btn btn-icon btn-3 btn-warning" href="/icd-admin-neonatal-view">
                                      ...
                                      <tr>
                                          <td>
                                              <div class="d-flex px-3 py-1">
                                                  <div id="container2">
                                                      <div id="name2">{{ substr($registry_header2->hosp_name, 0, 2) }}
                                                      </div>
                                                  </div> &nbsp;&nbsp;&nbsp;&nbsp;
                                                  <div class="d-flex flex-column justify-content-center">
                                                      <h6 class="mb-0 text-sm">{{ strtoupper($registry_header2->hosp_name) }}</h6>
                                          ...
                                          <td>
                                              <p class="text-sm font-weight-normal mb-0">{{Carbon\Carbon::parse($registry_header2->month_year_icd)->format('F Y')}}</p>
                                          </td>
                                          ...
                                          <td class="align-middle text-center">
                                              ...
                                              <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                  <li><a class="dropdown-item text-bold" href="/icd-admin-neonatal-view-month/{{ Crypt::encrypt( $registry_header2->id )}}">
