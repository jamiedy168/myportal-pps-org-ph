...
<x-page-template bodyClass='g-sidenav-show  bg-gray-200'>
    <x-auth.navbars.sidebar activePage="neonatalICD" activeItem="neonatal-upload" activeSubitem=""></x-auth.navbars.sidebar>
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-4">
        ...
        <input type="hidden" value="{{ url('icd-neonatal-upload-save') }}" id="urlICDNeonatalUpload">
        <input type="hidden" value="{{ url('icd-neonatal-upload-check-exist') }}" id="urlICDNeonatalUploadCheckExist">
      
        <div class="row justify-content-center">
            <div class="col-12 col-md-8 ">
                <div class="card mx-3 mx-md-4 ">
                    <div class="card-header p-3 pb-2 bg-danger">
                        <h5 class="font-weight-bolder mb-0 text-white">Neonatal Upload</h5>
                            ...
                            <div class="col-12">
                                ...
                                <div class="row">
                                    <div class="col-12" style="text-align: right !important">
                                        ...
                                        <a class="btn btn-warning" href="/icd-neonatal-view" id="uploadBtn" form="admittedForm">Cancel</a>
                                    </div>
                                </div>
    ...
    <style>
        ...
        #my-awesome-dropzone {
            border: 2px dashed #cccccc !important; /* Dashed border */
  ...
  <script src="{{ asset('assets') }}/js/icd-neonatal.js"></script>
