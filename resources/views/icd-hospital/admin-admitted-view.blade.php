                ...
                <div class="col-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body pb-2">
                            ...
                            <form class="form-horizontal" action="{{ route('icd-admin-admitted-view-search') }}" method="GET" autocomplete="off">
                                <div class="row mb-2">
                                    <div class="col-12">
                                        <div class="row justify-content-md-center">
                                            <div class="col-lg-6 col-12">
                                                ...
                                                <div class="input-group input-group-outline" id="titleRow" style="margin-top: -5px !important">
                                                    <select name="hospital_id" id="hospital_id" class="form-control hospital">
                                ...
                                <div class="row mt-3 justify-content-md-center">
                                    <div class="col-12 col-md-12" >
                                        ...
                                        <a class="btn btn-icon btn-3 btn-warning" href="/icd-admin-admitted-view">
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <li><a class="dropdown-item text-bold" href="/icd-admin-admitted-view-month/{{ Crypt::encrypt( $registry_header2->id )}}">
