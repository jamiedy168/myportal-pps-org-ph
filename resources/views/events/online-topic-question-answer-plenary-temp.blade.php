<x-page-template bodyClass='g-sidenav-show  bg-gray-200'>
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-4">
            ...
            <input type="hidden" value="{{ url('event-online-topic-speaker-a-temp') }}" id="urlEventOnlineTopicSpeakerATemp">
                                            ...
                                            <div class="multisteps-form__panel pt-3 border-radius-xl bg-white js-active"
                                                ...
                                                <div class="row align-middle">
                                                    <div class="col-12 col-sm-12 col-md-3">
                                                        ...
                                                        <label class="text-bold">NEEDS IMPROVEMENT</label>
                                                    </div>
                                                    ...
                                                    <div class="col-12 col-sm-12 col-md-3">
                                                        ...
                                                        <label class="text-bold">SATISFACTORY</label>
                                                    </div>
                                                
                                                    <div class="col-12 col-sm-12 col-md-3">
                                                        <label class="text-bold">3 - </label>
                                                        <label class="text-bold">VERY SATISFACTORY</label>
                                                    </div>
                                                 
                                                    <div class="col-12 col-sm-12 col-md-3">
                                                        <label class="text-bold">4 - </label>
                                                         <label class="text-bold">OUTSTANDING</label>
                                                    </div>
                                                ...
                                                <div class="multisteps-form__content">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <label class="text-bold"><b>Relevance of the topic:</b>  The importance of the topic to my career/personal growth</label>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="row">
                                                               <div class="col-3">
                                                                 <div class="form-check form-check-inline">
                                                                    <input class="form-check-input" type="radio" name="speaker1_relevance" value="1">
                                                                    <label class="form-check-label" for="speaker1_relevance">1</label>
                                                                  </div>
                                                                </div> 
                                                                <div class="col-3">
                                                                    <div class="form-check form-check-inline">
                                                                       <input class="form-check-input" type="radio" name="speaker1_relevance" value="2">
                                                                       <label class="form-check-label" for="speaker1_relevance">2</label>
                                                                     </div>
                                                                </div>
                                                                <div class="col-3">
                                                                    <div class="form-check form-check-inline">
                                                                       <input class="form-check-input" type="radio" name="speaker1_relevance" value="3">
                                                                       <label class="form-check-label" for="speaker1_relevance">3</label>
                                                                     </div>
                                                                   </div> 
                                                                   <div class="col-3">
                                                                       <div class="form-check form-check-inline">
                                                                          <input class="form-check-input" type="radio" name="speaker1_relevance" value="4">
                                                                          <label class="form-check-label" for="speaker1_relevance">4</label>
                                                                        </div>
                                                                   </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <label class="text-bold"><b>Usefulness of information conveyed:</b> The value of knowledge obtained from the talk</label>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-2 bg-gray-200 mb-3">
                                                        <div class="col-12 col-md-12 align-middle my-auto">
                                                            <div class="row">
                                                               <div class="col-3">
                                                                 <div class="form-check form-check-inline">
                                                                    <input class="form-check-input" type="radio" name="speaker1_usefulness" value="1">
                                                                    <label class="form-check-label" for="speaker1_usefulness">1</label>
                                                                  </div>
                                                                </div> 
                                                                <div class="col-3">
                                                                    <div class="form-check form-check-inline">
                                                                       <input class="form-check-input" type="radio" name="speaker1_usefulness" value="2">
                                                                       <label class="form-check-label" for="speaker1_usefulness">2</label>
                                                                     </div>
                                                                </div>
                                                                <div class="col-3">
                                                                    <div class="form-check form-check-inline">
                                                                       <input class="form-check-input" type="radio" name="speaker1_usefulness" value="3">
                                                                       <label class="form-check-label" for="speaker1_usefulness">3</label>
                                                                     </div>
                                                                   </div> 
                                                                   <div class="col-3">
                                                                       <div class="form-check form-check-inline">
                                                                          <input class="form-check-input" type="radio" name="speaker1_usefulness" value="4">
                                                                          <label class="form-check-label" for="speaker1_usefulness">4</label>
                                                                        </div>
                                                                   </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <label class="text-bold"><b>Quality of the presentation:</b>  The readability and clarity of the audiovisual presentation</label>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-2 bg-gray-200 mb-3">
                                                        <div class="col-12 col-md-12 align-middle my-auto">
                                                            <div class="row">
                                                               <div class="col-3">
                                                                 <div class="form-check form-check-inline">
                                                                    <input class="form-check-input" type="radio" name="speaker1_quality" value="1">
                                                                    <label class="form-check-label" for="speaker1_quality">1</label>
                                                                  </div>
                                                                </div> 
                                                                <div class="col-3">
                                                                    <div class="form-check form-check-inline">
                                                                       <input class="form-check-input" type="radio" name="speaker1_quality" value="2">
                                                                       <label class="form-check-label" for="speaker1_quality">2</label>
                                                                     </div>
                                                                </div>
                                                                <div class="col-3">
                                                                    <div class="form-check form-check-inline">
                                                                       <input class="form-check-input" type="radio" name="speaker1_quality" value="3">
                                                                       <label class="form-check-label" for="speaker1_quality">3</label>
                                                                     </div>
                                                                   </div> 
                                                                   <div class="col-3">
                                                                       <div class="form-check form-check-inline">
                                                                          <input class="form-check-input" type="radio" name="speaker1_quality" value="4">
                                                                          <label class="form-check-label" for="speaker1_quality">4</label>
                                                                        </div>
                                                                   </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <label class="text-bold"><b>Expertise of the Speaker:</b>  The level and extent of expertise of the resource speaker on the topic tackled</label>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-2 bg-gray-200 mb-3">
                                                        <div class="col-12 col-md-12 align-middle my-auto">
                                                            <div class="row">
                                                               <div class="col-3">
                                                                 <div class="form-check form-check-inline">
                                                                    <input class="form-check-input" type="radio" name="speaker1_expertise " value="1">
                                                                    <label class="form-check-label" for="speaker1_expertise">1</label>
                                                                  </div>
                                                                </div> 
                                                                <div class="col-3">
                                                                    <div class="form-check form-check-inline">
                                                                       <input class="form-check-input" type="radio" name="speaker1_expertise" value="2">
                                                                       <label class="form-check-label" for="speaker1_expertise">2</label>
                                                                     </div>
                                                                </div>
                                                                <div class="col-3">
                                                                    <div class="form-check form-check-inline">
                                                                       <input class="form-check-input" type="radio" name="speaker1_expertise" value="3">
                                                                       <label class="form-check-label" for="speaker1_expertise">3</label>
                                                                     </div>
                                                                   </div> 
                                                                   <div class="col-3">
                                                                       <div class="form-check form-check-inline">
                                                                          <input class="form-check-input" type="radio" name="speaker1_expertise" value="4">
                                                                          <label class="form-check-label" for="speaker1_expertise">4</label>
                                                                        </div>
                                                                   </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <label class="text-bold"><b>Speaker’s delivery and style.</b>  The Speaker’s manner of presenting the topic and sustaining audience attention</label>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-2 bg-gray-200 mb-3">
                                                        <div class="col-12 col-md-12 align-middle my-auto">
                                                            <div class="row">
                                                               <div class="col-3">
                                                                 <div class="form-check form-check-inline">
                                                                    <input class="form-check-input" type="radio" name="speaker1_delivery" value="1">
                                                                    <label class="form-check-label" for="speaker1_delivery">1</label>
                                                                  </div>
                                                                </div> 
                                                                <div class="col-3">
                                                                    <div class="form-check form-check-inline">
                                                                       <input class="form-check-input" type="radio" name="speaker1_delivery" value="2">
                                                                       <label class="form-check-label" for="speaker1_delivery">2</label>
                                                                     </div>
                                                                </div>
                                                                <div class="col-3">
                                                                    <div class="form-check form-check-inline">
                                                                       <input class="form-check-input" type="radio" name="speaker1_delivery" value="3">
                                                                       <label class="form-check-label" for="speaker1_delivery">3</label>
                                                                     </div>
                                                                   </div> 
                                                                   <div class="col-3">
                                                                       <div class="form-check form-check-inline">
                                                                          <input class="form-check-input" type="radio" name="speaker1_delivery" value="4">
                                                                          <label class="form-check-label" for="speaker1_delivery">4</label>
                                                                        </div>
                                                                   </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <label class="text-bold"><b>Time Management.</b>  The ability of the speaker in keeping his talk to the allotted time</label>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-2 bg-gray-200 mb-3">
                                                        <div class="col-12 col-md-12 align-middle my-auto">
                                                            <div class="row">
                                                               <div class="col-3">
                                                                 <div class="form-check form-check-inline">
                                                                    <input class="form-check-input" type="radio" name="speaker1_time_management" value="1">
                                                                    <label class="form-check-label" for="speaker1_time_management">1</label>
                                                                  </div>
                                                                </div> 
                                                                <div class="col-3">
                                                                    <div class="form-check form-check-inline">
                                                                       <input class="form-check-input" type="radio" name="speaker1_time_management" value="2">
                                                                       <label class="form-check-label" for="speaker1_time_management">2</label>
                                                                     </div>
                                                                </div>
                                                                <div class="col-3">
                                                                    <div class="form-check form-check-inline">
                                                                       <input class="form-check-input" type="radio" name="speaker1_time_management" value="3">
                                                                       <label class="form-check-label" for="speaker1_time_management">3</label>
                                                                     </div>
                                                                   </div> 
                                                                   <div class="col-3">
                                                                       <div class="form-check form-check-inline">
                                                                          <input class="form-check-input" type="radio" name="speaker1_time_management" value="4">
                                                                          <label class="form-check-label" for="speaker1_time_management">4</label>
                                                                        </div>
                                                                   </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <label class="text-bold"><b>Environment.</b> The venue as well as the sound system as being conducive, comfortable and good for learning</label>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-2 bg-gray-200 mb-3">
                                                        <div class="col-12 col-md-12 align-middle my-auto">
                                                            <div class="row">
                                                               <div class="col-3">
                                                                 <div class="form-check form-check-inline">
                                                                    <input class="form-check-input" type="radio" name="speaker1_environment" value="1">
                                                                    <label class="form-check-label" for="speaker1_environment">1</label>
                                                                  </div>
                                                                </div> 
                                                                <div class="col-3">
                                                                    <div class="form-check form-check-inline">
                                                                       <input class="form-check-input" type="radio" name="speaker1_environment" value="2">
                                                                       <label class="form-check-label" for="speaker1_environment">2</label>
                                                                     </div>
                                                                </div>
                                                                <div class="col-3">
                                                                    <div class="form-check form-check-inline">
                                                                       <input class="form-check-input" type="radio" name="speaker1_environment" value="3">
                                                                       <label class="form-check-label" for="speaker1_environment">3</label>
                                                                     </div>
                                                                   </div> 
                                                                   <div class="col-3">
                                                                       <div class="form-check form-check-inline">
                                                                          <input class="form-check-input" type="radio" name="speaker1_environment" value="4">
                                                                          <label class="form-check-label" for="speaker1_environment">4</label>
                                                                        </div>
                                                                   </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="button-row d-flex mt-4">
                                                        <button class="btn bg-gradient-success btn-lg ms-auto mb-0 js-btn-next proceed-next" id="formTempBtn"
