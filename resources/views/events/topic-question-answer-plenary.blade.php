<x-page-template bodyClass='g-sidenav-show  bg-gray-200'>
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-4">
            ...
            <input type="hidden" value="{{ url('event-topic-speaker-a') }}" id="urlEventTopicSpeakerA">
            ...
            <input type="hidden" value="{{ url('event-topic-finalize-plenary') }}" id="urlEventTopicFinalizePlenary">
    ...
    <script src="{{ asset('assets') }}/js/topic-question-answer-plenary.js"></script>
