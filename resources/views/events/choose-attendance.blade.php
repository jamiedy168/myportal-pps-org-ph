                ...
                <div class="col-lg-10 col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row mt-0">
                                <div class="col-12">
                                    <form class="form-horizontal" action="/event-choose-attendance-search" method="GET" autocomplete="off">
                                        <div class="row mt-4">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center !important">
                                                        ...
                                                        <p class="text-sm text-secondary mb-0">{{ $event2->start_dt->format('h: i a') }}</p>
                                                    </td>
                                                    
                                                    <td class="align-middle text-center">
                                                        <a href="event-attendance/{{ Crypt::encrypt( $event2->id )}}" class="btn btn-icon btn-danger btn-outline-danger w-100 mt-3"    type="button">
