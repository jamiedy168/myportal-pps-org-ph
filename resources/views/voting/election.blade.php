                            ...
                            <div class="col-md-12 col-12">
                                ...
                                <div class="row mt-4">
                                    <div class="col-12">
                                        ...
                                        <input type="hidden" id="botMaxVote" value="{{ $voting->bot_max_vote }}">
                                                ...
                                                <div class="col-lg-3 col-6 mb-5">
                                                    <div class="card h-100">
                                                        ...
                                                        <div class="card-body text-center mb-0">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12 col-12">
                                                                    <h5 class="font-weight-normal mt-1 text-danger candidate-name">
                                                        ...
                                                        <div class="card-footer d-flex mt-0">
                                                            <input type="checkbox" name="selected_bot_candidates[]" value="{{ $botCandidate2->pps_no }}" class="d-none bot-candidate-checkbox" id="chk-{{ $botCandidate2->pps_no }}">
                                                            <button type="button" class="btn btn-danger btn-sm mb-0 w-100 vote-bot-btn" data-target="#chk-{{ $botCandidate2->pps_no }}">
                                                                SELECT
                                                            </button>
                                                        </div>
                                        ...
                                        <input type="hidden" id="chapRepMaxVote" value="{{ $voting->chaprep_max_vote }}">
                                        <div class="row mt-5">
                                            <div class="col-md-12">
                                        ...
                                        <div class="row mt-5">
                                            @foreach ($chapRepCandidate as $chapRepCandidate2)
                                                <div class="col-lg-3 col-6 mb-5">
                                                    ...
                                                    <hr class="dark horizontal mb-0" style="margin-top: -17px !important">
                                                        <div class="card-footer d-flex mt-0">
                                                            <input type="checkbox" name="selected_chap_rep_candidates[]" value="{{ $chapRepCandidate2->pps_no }}" class="d-none chap-rep-candidate-checkbox" id="chk-{{ $chapRepCandidate2->pps_no }}">
                                                            <button type="button" class="btn btn-danger btn-sm mb-0 w-100 vote-chap-rep-btn" data-target="#chk-{{ $chapRepCandidate2->pps_no }}">
                                                                SELECT
                                                            </button>
                                                        </div>
                                                    </div>
