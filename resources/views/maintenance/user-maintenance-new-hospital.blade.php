...
<x-page-template bodyClass='g-sidenav-show  bg-gray-200'>
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      <!-- Navbar -->
      <x-auth.navbars.navs.auth pageTitle="New Hospital User"></x-auth.navbars.navs.auth>
      <!-- End Navbar -->

      <div class="container-fluid py-4">


        <form method="POST" id="user-maintenance-add-new-hospital" role="form text-left" enctype="multipart/form-data" >
            @csrf

            <input type="hidden" value="{{ url('user-maintenance-add-new-hospital') }}" id="urlUserMaintenanceAddNewHospital">
                ...
                <div class="col-lg-12 col-12">
                    <div class="card card-body" id="profile">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-lg-6 col-12">
                                <label class="form-label text-bold">Hospital Name</label>
                                <div class="input-group input-group-outline" style="margin-top: -5px !important">
                                    <select name="hospital" id="hospital_id" class="form-control hospital" required>
                                            <option value="">Choose</option>
                                        @foreach ($hospital_list as $hospital_list2)
                                            <option value="{{ $hospital_list2->id }}">{{ $hospital_list2->hosp_name }}</option>
                                        @endforeach
