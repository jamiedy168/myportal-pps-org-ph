...
function sidebarType(e) {
	...
	for (var o, r, d, c = document.querySelector(".sidenav"), s = 0; s < l.length; s++) c.classList.remove(l[s]);
...
function darkMode(e) {
	...
	if (e.getAttribute("checked")) {
		...
		for (b = 0; b < a.length; b++) a[b].classList.contains("light") && (a[b].classList.add("dark"), a[b].classList.remove("light"));
		for (b = 0; b < n.length; b++) n[b].classList.contains("light") && (n[b].classList.add("dark"), n[b].classList.remove("light"));
		for (b = 0; b < i.length; b++) i[b].classList.contains("text-white") && (i[b].classList.remove("text-white"), i[b].classList.add("text-dark"));
		for (b = 0; b < s.length; b++) !s[b].classList.contains("text-white") || s[b].closest(".sidenav") || s[b].closest(".card.bg-gradient-dark") || (s[b].classList.remove("text-white"), s[b].classList.add("text-dark"));
		for (b = 0; b < r.length; b++) r[b].classList.contains("text-white") && (r[b].classList.remove("text-white"), r[b].classList.add("text-dark"));
		for (b = 0; b < c.length; b++) c[b].classList.contains("text-white") && !c[b].closest(".sidenav") && (c[b].classList.remove("text-white"), c[b].classList.add("text-dark"));
		for (b = 0; b < u.length; b++) u[b].classList.contains("text-white") && (u[b].classList.remove("text-white"), u[b].classList.remove("opacity-8"), u[b].classList.add("text-dark"));
		for (b = 0; b < g.length; b++) g[b].classList.contains("bg-gray-600") && (g[b].classList.remove("bg-gray-600"), g[b].classList.add("bg-gray-100"));
		for (b = 0; b < p.length; b++) p[b].hasAttribute("fill") && p[b].setAttribute("fill", "#252f40");
		for (b = 0; b < v.length; b++) v[b].closest(".card.bg-gradient-dark") || (v[b].classList.remove("text-white"), v[b].classList.add("text-dark"));
		for (b = 0; b < y.length; b++) y[b].classList.remove("border-dark");
		e.removeAttribute("checked")
	} else {
		t.classList.add("dark-version");
		for (var b = 0; b < a.length; b++) a[b].classList.contains("dark") && (a[b].classList.remove("dark"), a[b].classList.add("light"));
		for (var b = 0; b < n.length; b++) n[b].classList.contains("dark") && (n[b].classList.remove("dark"), n[b].classList.add("light"));
		for (var b = 0; b < i.length; b++) i[b].classList.contains("text-dark") && (i[b].classList.remove("text-dark"), i[b].classList.add("text-white"));
		for (var b = 0; b < l.length; b++) l[b].classList.contains("text-dark") && (l[b].classList.remove("text-dark"), l[b].classList.add("text-white"));
		...
		for (var b = 0; b < u.length; b++) u[b].classList.contains("text-secondary") && (u[b].classList.remove("text-secondary"), u[b].classList.add("text-white"), u[b].classList.add("opacity-8"));
		for (var b = 0; b < m.length; b++) m[b].classList.contains("bg-gray-100") && (m[b].classList.remove("bg-gray-100"), m[b].classList.add("bg-gray-600"));
		for (var b = 0; b < f.length; b++) f[b].classList.remove("text-dark"), f[b].classList.add("text-white");
		for (var b = 0; b < p.length; b++) p[b].hasAttribute("fill") && p[b].setAttribute("fill", "#fff");
