	...
	e = Object.freeze({
		...
		_main: function(e, t = {}) {
			...
			return Le(this, e), he.innerParams.set(this, e), s = this, r = t, c = e, new Promise(e => {
				...
				ot.swalPromiseResolve.set(s, e), r.confirmButton.onclick = () => ((e, t) => {
				...
				})(s, t), r.closeButton.onclick = () => t(l.close), n = s, a = r, e = t, he.innerParams.get(n).toast ? Jt(n, a, e) : (Xt(a), Gt(a), Qt(n, a, e)), o = s, a = Me, e = c, i = t, a.keydownTarget && a.keydownHandlerAdded && (a.keydownTarget.removeEventListener("keydown", a.keydownHandler, {
					...
					capture: a.keydownListenerCapture
				}), a.keydownHandlerAdded = !0), e = s, "select" === (a = c).input || "radio" === a.input ? Lt(e, a) : ["text", "email", "number", "tel", "textarea"].includes(a.input) && (u(a.inputValue) || p(a.inputValue)) && jt(e, a), At(c), en(Me, c, t), tn(r, c), setTimeout(() => {
